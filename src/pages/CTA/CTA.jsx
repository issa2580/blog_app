    ...
    return (
        <>
            ...
            {/* <section className='relative bg-dark-hard '>
                <div className='container grid-cols-12 mx-auto py-10 md:pb-20 xl:place-items-center'>
                    <div className='col-span-12 xl:col-span-6'>
                        <h2 className='text-white font-roboto font-bold text-2xl md:text-4xl md:text-center md:leading-normal xl:text-left'>
                            Get our stories delivered From us to your inbox weekly.
                        </h2>
                        <div className='w-full max-w-[494px] mt-12 space-y-3 mx-auto md:space-y-0 md:flex md:items-center md:space-x-2 xl:mx-0'>
                            <input 
                                className='px-4 py-3 rounded-lg w-full placeholder:text-dark-light'
                                type="text"
                                placeholder='Your Email' 
                            />
                            <button className='px-4 py-3 rounded-lg w-full bg-primary text-white font-bold hover:bg-white hover:text-primary md:w-fit md:whitespace-nowrap'>
                                Get started
                            </button>
                        </div>
                        <p className='text-dark-light text-sm leading-7 mt-6 md:text-center md:text-base xl:text-left' >
                            <span className='font-bold italic text-[#B3BAC5] md:not-italic md:font-normal md:text-dark-light'>Get a response tomorrow</span> if you submit by 9pm today. 
                            If we received after 9pm will get a reponse the following day.
                        </p>
                    </div>
                    <div className='col-span-12 hidden mb-[70px] md:block md:order-first xl:col-span-6 xl:order-last'>
                        <div className='w-3/4 mx-auto relative'>
                            ...
                            <div className='w-full rounded-xl bg-white p-3 z-[1] relative'>
                                ...
                                />
                                <div className='p-5'>
                                    <h2 className='font-roboto font-bold text-xl text-dark-soft md:text-2xl xl:text-[28px]'>
                                        tts
                                    </h2>
