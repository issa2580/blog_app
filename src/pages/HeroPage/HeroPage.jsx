...
const HeroPage = () => {
    return (
        <section className='container mx-auto flex flex-col lg:flex-row py-5'>
            <div className='mt-10 lg:w-1/2'>
                ...
                <div className='flex flex-col gap-y-2.5 mt-10 relative'>
                    ...
                    <button className='w-full bg-primary text-white rounded-lg px-5 py-3 md:absolute md:right-2 md:top-1/2 md:-translate-y-1/2 md:w-fit md:py-2'>
                        Search
                    </button>
                </div>
            ...
            <div className='hidden lg:block lg:h-1/2'>
                <img className='w-full' src={Chat} alt="live chat" />
            </div>
        </section>
    );
}
